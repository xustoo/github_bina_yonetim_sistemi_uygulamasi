...
namespace Bina_yönetim_uygulaması
{
    public partial class frAna : Form
    {
        ...
        // Kullanıcı programı kullandığında.
        private void btnKullanıcı_Click(object sender, EventArgs e)
        {
            kullanıcıgöster();
        }
        //  Yönetici bilgilerini girdiğinde menüye geçme butonu.
        ...
        //  Kullanıcı kayıt edilen veriler arasından kendi dairesini combobox ile seçme verilerini sql den çekme.
        void DaireVerileri()
        {
        ...
        // Kullanıcının seçtiği dairenin sql de bulunduğu konumu parametre olarak gönderme.
